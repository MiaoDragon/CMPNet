cd ..
python cmpnet_test.py --model_path /media/arclabdl1/HD1/YLmiao/results/CMPnet_res/home_mlp2/ \
...
--start_epoch 4 --memory_type res --env_type home_mlp2 --world_size 20 \
