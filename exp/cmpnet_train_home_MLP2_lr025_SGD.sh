...
python cmpnet_train.py --model_path /media/arclabdl1/HD1/YLmiao/results/CMPnet_res/home_mlp2_lr025_SGD/ \
--no_env 1 --no_motion_paths 2196 --grad_step 1 --learning_rate 0.025 \
