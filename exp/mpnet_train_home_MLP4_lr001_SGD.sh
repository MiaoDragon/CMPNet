...
python mpnet_train.py --model_path /media/arclabdl1/HD1/YLmiao/results/MPnet_res/home_mlp4_lr001_SGD/ \
--no_env 1 --no_motion_paths 1800 --grad_step 1 --learning_rate 0.001 \
--num_epochs 500 --memory_strength 0.5 --n_memories 1 --opt SGD \
--n_tasks 1 --device 3 --freq_rehersal 100 --batch_rehersal 100 --batch_size 100 \
