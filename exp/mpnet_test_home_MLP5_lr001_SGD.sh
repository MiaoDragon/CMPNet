cd ..
python mpnet_test.py --model_path /media/arclabdl1/HD1/YLmiao/results/MPnet_res/home_mlp5_lr001_SGD/ \
...
--start_epoch 10 --memory_type res --env_type home_mlp5 --world_size 20 \
