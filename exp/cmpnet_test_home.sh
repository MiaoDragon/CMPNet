...
--start_epoch 4 --memory_type res --env_type home --world_size 20 \
--total_input_size 150008 --AE_input_size 32 32 32 1 --mlp_input_size 142 --output_size 7 \
--seen_N 1 --seen_NP 100 --seen_s 0 --seen_sp 2700 \
