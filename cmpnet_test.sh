...
python cmpnet_test.py --model_path CMPnet_res/baxter_test_server_1/baxter_test/ \
--grad_step 1 --learning_rate 0.01 \
--memory_strength 0.5 --n_memories 10000 \
--n_tasks 1 --device 0 --data_path ../data/test/ \
--start_epoch 4 --memory_type res --env_type baxter --world_size 20 \
