...
python3 cmpnet_train.py --model_path ../CMPnet_res/r2d/adagrad/simple/ \
--no_env 100 --no_motion_paths 4000 --grad_step 1 --learning_rate 0.005 \
...
--memory_type res --total_input_size 2806 --AE_input_size 2800 --mlp_input_size 262 --output_size 3 --opt Adagrad \
--train_path 1
