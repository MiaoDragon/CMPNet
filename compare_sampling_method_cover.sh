...
python3 cmpnet_compare_sample.py --model_path ../CMPnet_res/s2d/sample_exp/cover/ \
--no_env 2 --no_motion_paths 2 --grad_step 1 --learning_rate 0.01 \
...
--memory_type prio_cover --total_input_size 2804 --AE_input_size 2800 --mlp_input_size 32 --output_size 2 --train_path 1 \
--seen_N 0 --seen_NP 0 --seen_s 0 --seen_sp 4000 \
--unseen_N 0 --unseen_NP 0 --unseen_s 100 --unseen_sp 0
