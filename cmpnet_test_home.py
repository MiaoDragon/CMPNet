    ...
    for _ in range(T):
        ...
        if args.seen_N > 0:
            if args.use_local_reorder:
                time_file = os.path.join("./",'time_seen_epoch_%d_mlp_local_reorder.p' % (args.start_epoch))
            else:
                time_file = os.path.join("./",'time_seen_epoch_%d_mlp.p' % (args.start_epoch))
...
if __name__ == '__main__':
    ...
    parser.add_argument('--n_memories', type=int, default=1, help='number of memories for each task')
    parser.add_argument('--memory_strength', type=float, default=0.5, help='memory strength (meaning depends on memory)')
    # Model parameters
    parser.add_argument('--total_input_size', type=int, default=150008, help='dimension of total input')
    parser.add_argument('--AE_input_size', nargs='+', type=int, default=[1, 32, 32, 32], help='dimension of input to AE')
    parser.add_argument('--mlp_input_size', type=int , default=78, help='dimension of the input vector')
    parser.add_argument('--output_size', type=int , default=7, help='dimension of the input vector')
    parser.add_argument('--learning_rate', type=float, default=0.01)
    parser.add_argument('--device', type=int, default=0, help='cuda device')
    parser.add_argument('--data_path', type=str, default='/media/arclabdl1/HD1/YLmiao/data/home/challenge_data/')
    ...
    parser.add_argument('--env_type', type=str, default='home_mlp2', help='s2d for simple 2d, c2d for complex 2d')
