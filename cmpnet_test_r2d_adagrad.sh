python3 cmpnet_test.py --model_path ../CMPnet_res/r2d/adagrad/simple/ \
...
--total_input_size 2806 --AE_input_size 2800 --mlp_input_size 262 --output_size 3 \
--seen_N 100 --seen_NP 200 --seen_s 0 --seen_sp 4000 \
--unseen_N 10 --unseen_NP 2000 --unseen_s 100 --unseen_sp 0 --opt Adagrad --train_path 1
# seen: 100, 200, 0, 4000
